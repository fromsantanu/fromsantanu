...
### Artificial Intelligence and its Applications
  - [**Introduction to Machine Learning, Deep Learning Concepts**](https://github.com/fromsantanu/master-ml-dl/blob/main/README.md) : This section provides complete roadmap and required tutotals for AI Engineers without getting into computational complexity. This section covers Machine Learning, Deep learning concepts and its application in Computer Vision, Natural language Processing and other areas. This section is suitable for those looking to be AI Engineers. But they will require more indepth study to become a master of trade.
