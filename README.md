...
### Data Analysis, Research Using Statistics
...
### Artificial Intelligence - The Mechanism Behind it
  ...
  - **Deep Learning Technologies (DL)**
    - [**Artificial Neural Networks - A Comprehensive Overview**](https://github.com/fromsantanu/ANNTut/blob/main/README.md) : This tutorial provides a structured and easy-to-follow journey through Artificial Neural Networks, starting from basic concepts and building up to advanced architectures like CNNs and Transformers. It explains how neural networks learn, the challenges involved, and the techniques used to improve performance. Finally, it connects theory to real-world applications and practical implementation using modern tools.
      - [**ANN Beginner Project - PyTorch**](https://github.com/fromsantanu/ANN-Project/blob/main/README.md) : This project builds a simple Artificial Neural Network using PyTorch to predict outcomes like health risk, student performance, or loan approval. It explains each concept step-by-step—from basic decision-making to full model training—in a clear and practical way. By the end, learners can confidently design, train, and test their own neural network models on real-world problems.
      - [**ANN Intermediate Project - PyTorch**](https://github.com/fromsantanu/ANNIntProj/blob/main/README.md) : This project builds an Artificial Neural Network (ANN) using PyTorch to predict whether a customer will stay or leave based on their data. It covers the complete pipeline—from data preprocessing and model building to training, evaluation, and improvement. The goal is to help learners understand and implement a real-world machine learning solution step by step.
    - [**Convolutional Neural Networks - A Comprehensive Overview**](https://github.com/fromsantanu/CNNTut/blob/main/README.md) : This tutorial teaches Convolutional Neural Networks (CNNs) step by step, starting from how images are represented to how models learn patterns like edges, shapes, and objects. It combines simple explanations, visual intuition, and small PyTorch programs so students can clearly understand and build their own CNN models. By the end, learners apply their knowledge to real-world tasks such as image classification and basic X-ray analysis.
    - [**Recurrent Neural Networks - A Comprehensive Overview**](https://github.com/fromsantanu/RNNTut/blob/main/README.md) : This tutorial teaches Recurrent Neural Networks (RNNs) step by step, starting from basic ideas like sequential data and gradually building up to advanced concepts like LSTM and GRU. It combines simple explanations with practical examples and PyTorch implementations so learners can understand both the theory and how to apply it. By the end, students will be able to build, train, and improve RNN models for real-world problems like text prediction and time-series forecasting.
...
- [**Prompt Engineering**](https://github.com/fromsantanu/LLM-Based-Agentic-Systems/blob/main/PROMPT/README.md) : A practical guide to designing effective prompts for ChatGPT, covering core techniques, advanced strategies, and real-world use cases across domains. It also explores optimization, evaluation, tool integration, and responsible prompting to build reliable and high-quality AI interactions.
...
### Applications of Artificial Intelligence
  ...
  - [**Introduction to Voice Cloning Systems**](https://github.com/fromsantanu/VoiceCloningSystem/blob/main/README.md) : Voice cloning is an important technique in natural language processing (NLP) and speech synthesis. It is a generative approach that uses artificial neural network models to transform one voice—characterized by its unique texture, timbre, and accent—into another voice with different characteristics. This tutorial introduces the fundamental methods behind voice cloning. It also includes a dedicated section on the RVC (Retrieval-Based Voice Conversion) method, which is one of the most widely used and popular approaches today.
  - [**Understanding AI Based Music Generation**](https://github.com/fromsantanu/AI-Based-Music-Generation/blob/main/README.md) : Music generation is one of the most exciting areas of AI, similar to text and image generation. This section teaches how to reliably generate different kinds of music using the Suno Music Generator. The tutorial is divided into four levels. The final level is intended for learners with a stronger technical background who want to explore the topic in greater depth. In addition, it includes four levels of capstone projects to help you apply and test your understanding.
  - [**Developing (End to End) Indian Music Generation System (Project Conceptualization)**](https://github.com/fromsantanu/DevIndianMusic/blob/main/README.md) : This section is based on the idea that the Indian music system is both complex and unique. It differs significantly from the way the Western music system has been conceptualized. Accordingly, this tutorial begins by exploring the key characteristics of Indian music. It then discusses, in a structured manner, how one might approach building such a system. This can also serve as a research project for those who are interested in exploring the topic further.
