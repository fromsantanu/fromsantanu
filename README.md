...
### Artificial Intelligence and its Applications
  - [**Mastery on Machine Learning, Deep Learning**](https://github.com/fromsantanu/master-ml-dl/blob/main/README.md) : This section provides complete roadmap and required tutotals for AI Engineers. This section covers Machine Learning, Deep learning concepts and its application in Computer Vision, Natural language Processing and other areas. This section is suitable for those looking to be AI Engineers.
