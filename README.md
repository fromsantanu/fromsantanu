...
- [**Complete Core Java Tutorial (Basic to Advanced)**](https://github.com/fromsantanu/Java-Language/blob/main/README.md): This tutorial contains chapters on Java programming related lessons. Each chapter has plenty of supporting examples to explain the concepts. The tutorial covers many advanced and latest features that have been later became part of Java after Oracle corporation has taken it over from SUN Systems.
