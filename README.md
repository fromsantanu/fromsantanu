...
### Artificial Intelligence and its Applications
  ...
  - [**Natural Language Processing**](#) : Natural language processing is one of the most important areas that demands attention. This tutorial is divided into seven parts in increasing order of complexity. The target audience of these tutorials are one those already familier with Basics of Machine learning and Deep learning concepts.
  - [**Understanding Text to Speech Systems**](#) : AI based **Text to Speech systems** are now heavily used in different domains. We have systems like Eleven Labs ann Speechify that can generate generate speeches of very quality from given text inputs. It can now deal with emotions and accents and also generate speeches on Non-English foreign languages. THis tutorial has lessons that teaches the fundamental process of converting from text-to-speech and discusses a system in details.
  ...
  - [**Developing (End to End) Indian Music Generation System (Project Conceptualization)**](#) : This section is based on our belief that Indian Music system is very complex and special. It is different from way Western Music System has been conceptualized. And thus this tutorial initially covers the specialities of Indian System of Music and discusses systematically about what to do for building such a system. THis is a research project that interested folks may consider taking up.
