...
### Artificial Intelligence and its Applications
  ...
  - [**Using OpenAI Codex for System Development (Only for Advanced Learners)**](https://github.com/fromsantanu/Codex-Development/blob/main/README.md) : If you have understood the technology discussed in the above two sections and hold strong foundation knowledge of both of them and you are familar with REST APS and System development lifecycle then you can use OpenAI Codex to increase your productivity to systematically build complex systems that can be used in real life scenario.
